...
void WinLightSetup::SetProperties()
{
	...
	GetPar(fixture_number_t(0)).GetPlatformFixture().SetProperties("Front", "Left 4", "FL4", 2, 1);
	GetPar(fixture_number_t(1)).GetPlatformFixture().SetProperties("Front", "Left 3", "FL3", 3, 1);
	GetPar(fixture_number_t(2)).GetPlatformFixture().SetProperties("Front", "Left 2", "FL2", 4, 1);
	GetPar(fixture_number_t(3)).GetPlatformFixture().SetProperties("Front", "Left 1", "FL1", 5, 1);
	...
	GetPar(fixture_number_t(8)).GetPlatformFixture().SetProperties("Drums", "Left", "DL", 8, 3);
	GetPar(fixture_number_t(9)).GetPlatformFixture().SetProperties("Drums", "Right", "DR", 9, 3);
	...
	// LED Bars.
	GetPar(fixture_number_t(14)).GetPlatformFixture().SetProperties("LED Bar", "Left", "LL", 1, 3);
	GetPar(fixture_number_t(15)).GetPlatformFixture().SetProperties("LED Bar", "Center", "LC", 3, 3);
	GetPar(fixture_number_t(16)).GetPlatformFixture().SetProperties("LED Bar", "Right", "LR", 5, 3);
...
void WinLightSetup::PrintHeader() const
{
	...
	OutputDebugString(L"│   │    │   ├▬▬▬┬▬▬▬┬▬▬▬┬▬▬▬┬▬▬▬┼▬▬▬┬▬▬▬┬▬▬▬┬▬▬▬┬▬▬▬┼▬▬▬┬▬▬▬┬▬▬▬┬▬▬▬┬▬▬▬┼▬▬▬▬┬▬▬▬▬▬▬▬┬▬▬▬▬┼▬▬▬▬┼▬▬▬┼▬▬▬▬▬┼▬▬▬▬▬┬▬▬▬▬▬┼▬▬▬▬▬┬▬▬▬▬▬┬▬▬▬▬▬▬▬▬┼\n");
	OutputDebugString(L"│   │    │Off│Int│Red│Gre│Bl │Whi│Int│Red│Gre│Bl │Whi│Int│Red│Gre│Bl │Whi│Init│Program│Hold|Once│For│Param│Param│Param│Curr │Nr of│ Step   │\n");
	OutputDebugString(L"│   │    │Cha│ens│   │ en│ ue│ te│ens│   │ en│ ue│ te│ens│   │ en│ ue│ te│    │Number │    │    │Upd│  1  │  2  │  3  │Step │Steps│Duration│\n");
	OutputDebugString(L"┼▬▬▬┼▬▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┬▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬┼▬▬▬▬┼▬▬▬▬▬▬▬┼▬▬▬▬┼▬▬▬▬┼▬▬▬┼▬▬▬▬▬┼▬▬▬▬▬┼▬▬▬▬▬┼▬▬▬▬▬┼▬▬▬▬▬┼▬▬▬▬▬▬▬▬┼\n");
...
void WinLightSetup::PrintFixture(fixture_number_t fixtureNumber) const
{
	...
	//                   Par Number                                                        Init Program                                      Step Number
	//                      |  Abbreviation                                                           \   Program                                   |    Number of Steps
	//                      |     |  DMX Channel                                                       \  Number                Force               |    / 
	//                      |     |      |    --Actual Color--   --Default Color--   -Alternate Color-  \    |   Hold  Once     Update  Parameters  |   /  Step Duration
	//                      |     |      |   /                \ /                 \ /                 \  |   |     |     |        |    /         |  |   |   |
	swprintf_s(message, L"│%2u │%c%c%c │%3u│%3u:%3u:%3u:%3u:%3u│%3u:%3u:%3u:%3u:%3u│%3u:%3u:%3u:%3u:%3u│%4u:%7u:%c%c%c :%c%c%c |%c%c%c|%5u:%5u:%5u│%5u:%5u:%6u  │\n",
		fixtureNumber,
		...
		par.GetHold() ? ' ' : 'O', par.GetHold() ? 'O' : 'f', par.GetHold() ? 'N' : 'f',
...
void WinLightSetup::PrintFooter() const
{
	...
	//                   Par Abbr DMX <---ActualColor---> <---DefaultColor--> <-AlternateColor--> Init Prog Nr Hold Once <---Parameters--> StepN NrOfS StepDura
 	OutputDebugString(L"└▬▬▬┴▬▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬┴▬▬▬▬┴▬▬▬▬▬▬▬┴▬▬▬▬┴▬▬▬▬┴▬▬▬▬▬┴▬▬▬▬▬┴▬▬▬▬▬┴▬▬▬▬▬┴▬▬▬▬▬┴▬▬▬▬▬▬▬▬┼\n");
